                    ...
                    echo '<div class="card" style="border-radius: 10px 10px 10px 10px;background-color:#e1f5fae4;">
                            <div class="card-body">
                                ...
                                <div class="MlisUno">
                                    <ul class="ml-2">
                                        <li>
                                            <h5 class="m-1"><strong>'.$TablaOver['nombre'].'</strong></h5>
                                        </li>
                                        <li class="posder">
                                            <a data-bs-toggle="modal" data-bs-target="#editarlistamod" class="hovlist" onclick="storeProductIdEdit(' . $TablaOver['id_Lista'] . ')">
                                                <h6 class="m-1">Editar lista<i class="bi bi-pencil-square"></i></h6>
                                            </a>
                                        </li>
                                        <li class="posder">
                                            <a data-bs-toggle="modal" data-bs-target="#borrarlistamod" class="hovlist" onclick="storeProductIdBorrar(' . $TablaOver['id_Lista'] . ')">
                                    ...
                                    <ul class="ml-2">
                                        <li>
                                            <p class="m-1">'.$TablaOver['descripcion'].'</p>
                                        </li>
                                    </ul>
                                    <ul class="ml-2">
                                        <li>
                                    ...
                                    <a class="hovlist" data-bs-toggle="modal" data-bs-target="#verlistaprod" href="../Front/perfil_usuario.php?idListaProdVer='.$TablaOver['id_Lista'].'">
                                        <ul class="ml-2 pointprod">';
        
                                            $mime_typeL = 'image/png';
            
                                            $imagen_urlL = 'data:' . $mime_typeL . ';base64,' . base64_encode($TablaOver['img']);
                ...
                <div class="modal-body">
                    <div class="container ">
                        <row>
                            ...
                            <button type="button" class="btn btn-danger" name="confirmBTNeditarL">Confirmar</button>
                            </form>
                        </row>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container ">
                        ...
                        <button type="button" class="btn btn-danger" name="confirmBTNborrarL">Confirmar</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="container ">
                        <?php
                        if ($rowListasProdCount === 1){
                            $idProdLBorrar = 'idProdLBorrar_' . $listaProductosV['id_Producto'];
                            $btnElmProdLis = 'btnElmProdLis_' . $listaProductosV['id_Producto'];
                            echo '<a class="link-offset-2 link-underline link-underline-opacity-0 refervista" href="vistaProducto.php?idProductoEn='.$listaProductosV['id_Producto'].'" title="Ver detalles del producto">
                            <div class="card mb-3" style="max-width: 60%; background-color:#ecd3f0e4; border-radius: 30px;">
                                <div class="row g-0">
                                    <div class="col-md-4">';
                                            $mime_typeProd = 'image/png';
            
                                            $imagen_urlProd = 'data:' . $mime_typeProd . ';base64,' . base64_encode($listaProductosV['img_blob']);
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            <div class="badge btnColorCard" style="border-radius: 10px 30px;">
                                                <h6>'.$listaProductosV['producto_nombre'].'</h6>
                                            </div>
                                            <p class="card-text" style="padding-top: 1%;">'.$listaProductosV['producto_descripcion'].'</p>
                                            <p class="card-text"><small class="text-body-secondary"><strong>MXN$ '.$listaProductosV['producto_precio'].'</strong></small></p>
                                            <hr>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <input type="hidden" name="'.$idProdLBorrar.'" id="'.$idProdLBorrar.'" value="'.$listaProductosV['id_Producto'].'">
                        <button type="button" class="btn btn-secondary" id="'.$btnElmProdLis.'" name="'.$btnElmProdLis.'">Eliminar</button>
                        </form>
                        </div>';
                        } elseif ($rowListasProdCount > 1){
