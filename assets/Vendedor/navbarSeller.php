<nav class="navbar navbar-expand-lg sticky-top" style="background-color:#7D2C6F;">
    <div class="container-fluid letraFuente">
        <a class="navbar-brand text-light" href="http://localhost/prueba/PWCI/Front/vendedor.php">
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link text-light" href="http://localhost/prueba/PWCI/Front/n_producto.php">Nuevo
                        producto</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-light"
                        href="http://localhost/prueba/PWCI/Front/mensajes_vendedor.php">Mensajes</a>
                </li>
                <li class="nav-item">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="http://localhost/prueba/PWCI/Front/perfil_usuario.php" role="button"
